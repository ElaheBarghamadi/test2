...
import type { ApiManualGradeResponseDto, ApiStudentResultDto, ApiTeacherAttemptDetailDto, ApiTeacherOverviewDto, ApiTeacherResultRowDto, ApiTeacherStudentOverviewDto } from "@/lib/api/dtos";
...
export const resultsApi = {
  ...
  updateFeedback: (attemptId: string, feedback: string) => apiRequest<ApiStudentResultDto>(`/results/teacher/attempts/${attemptId}/feedback/`, { method: "PATCH", body: { feedback } }),
